<script>
	...
	let nodes = $state.raw([
		{ id: "1", position: { x: 300, y: 200 }, data: { label: "Svelte" } },
		{ id: "2", position: { x: 300, y: 300 }, data: { label: "Flow" } },
	]);
...
<div class="h-[calc(100vh-65px)] w-full">
	<SvelteFlow bind:nodes bind:edges colorMode={mode.current} fitView zoomOnDoubleClick>
