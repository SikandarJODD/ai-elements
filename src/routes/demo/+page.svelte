...
<div class="container mx-auto space-y-8 p-8">
	...
	<blockquote class="border-primary text-muted-foreground border-l-4 pl-4 italic">
		A simple guide to building AI-powered applications with Svelte 5's new runes system and the
		AI SDK. Learn how to create reactive AI interfaces with modern Svelte.
	</blockquote>
	...
	<div class="space-y-8">
		<section>
			...
			<p class="text-muted-foreground mb-4">
				Start by creating a new SvelteKit project and installing the AI SDK:
			</p>
			<CodeNameBlock
				filename="setup.sh"
				lang="bash"
...
npm install ai @ai-sdk/openai`}
		...
		<section>
			...
			<p class="text-muted-foreground mb-4">
				Create a simple chat component using Svelte 5 runes and the useChat hook:
			</p>
			<CodeNameBlock
...
export const POST: RequestHandler = async ({ request }) => {
	...
	return result.toDataStreamResponse();
		...
		<section>
			...
			<p class="text-muted-foreground mb-4">
				Use Svelte 5 runes for reactive AI state management:
			</p>
			<CodeNameBlock
