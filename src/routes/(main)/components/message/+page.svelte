  ...
  >
    ...
    <main class="min-w-0" bind:this={toc.ref}>
      ...
      <p class="my-2 !text-muted-foreground text-lg">
        The <CodeSpan>Message</CodeSpan> component displays a chat interface message
        from either a user or an AI. It includes an avatar, a name, and a message
        content.
      </p>
      ...
      <Installation specifier={`${PUBLIC_WEBSITE_URL}/r/message.json`} is_jsrepo={true} blockname="message" />
