...
<div class="space-y-2">
  <div class="h-[400px] w-full border rounded-lg overflow-hidden bg-background">
  ...
  <p class="text-xs text-muted-foreground px-2">
    💡 <strong>Try it:</strong> Drag from the Source node's right edge to connect to Target A or Target B
  </p>
</div>
