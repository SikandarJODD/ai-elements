...
<main class="min-w-0" bind:this={toc.ref}>
	...
	<p class="!text-muted-foreground my-2 text-lg">
		The <CodeSpan>Connection</CodeSpan> component provides a styled connection line for Svelte Flow
		canvases. It renders an animated bezier curve with a circle indicator at the target end, using
...
<div class="space-y-3">
  ...
  {/if}
	...
	<div class="my-4 space-y-4">
		<div class="border-primary border-l-2 pl-4">
			...
			<p class="text-muted-foreground text-sm">
				<span class="font-mono text-xs">number</span> - The x-coordinate of the connection start
				point (automatically provided by Svelte Flow).
			</p>
		</div>
		...
		<div class="border-primary border-l-2 pl-4">
			...
			<p class="text-muted-foreground text-sm">
				<span class="font-mono text-xs">number</span> - The y-coordinate of the connection start
				point (automatically provided by Svelte Flow).
			</p>
		</div>
	...
	<ul class="my-4 space-y-3 text-sm sm:text-base">
		...
		<li>
			<strong>Theme Integration:</strong> Automatically adapts colors to your theme using CSS
			variables like <CodeSpan>--primary</CodeSpan> and <CodeSpan>--card</CodeSpan>
		</li>
		<li>
...
@keyframes dash {
  to {
	...
	<ul class="my-4 space-y-3 text-sm sm:text-base">
		...
		<li>
			<strong>Provide user feedback:</strong> Show connection count, source/target labels, or status
			indicators after creating edges
		</li>
		<li>
	...
	<ul class="my-4 space-y-2 text-sm sm:text-base">
		<li>
			• Visual indicator circle helps users with motor impairments track cursor position
			during dragging
		</li>
		<li>
