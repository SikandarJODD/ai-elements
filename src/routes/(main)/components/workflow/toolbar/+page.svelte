...
<main class="min-w-0" bind:this={toc.ref}>
	...
	<p class="!text-muted-foreground my-2 text-lg">
		The <CodeSpan>Toolbar</CodeSpan> component provides a positioned toolbar that attaches to nodes
		in Svelte Flow canvases. It features modern card styling with backdrop blur and flexbox layout
	...
	<div class="my-4 space-y-4">
		...
		<div class="border-primary border-l-2 pl-4">
			...
			<p class="text-muted-foreground text-sm">
				...
				other props from @xyflow/svelte NodeToolbar component (position, offset, isVisible, etc.).
			</p>
		</div>
	</div>
...
<Node>
  ...
  <Toolbar>
	...
	<AiElementsPrevNext currentSlug="toolbar" />
</main>
