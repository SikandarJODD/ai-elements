  ...
  >
    <main class="min-w-0" bind:this={toc.ref}>
      ...
      <p class="my-2 !text-muted-foreground text-lg">
        ...
        Flow canvases. It includes support for connection handles, structured layouts, and
      ...
      <Installation specifier={`${PUBLIC_WEBSITE_URL}/r/node.json`} is_jsrepo={true} blockname="workflow" />
  ...
  <NodeFooter>
    Footer content
      ...
      <ul class="space-y-2 my-4 text-sm sm:text-base">
        ...
        <li>• Composable sub-components (Header, Title, Description, Action, Content, Footer)</li>
      ...
      <div class="space-y-6 my-4">
        <div>
          <p class="font-semibold mb-3">&lt;Node /&gt;</p>
          <div class="space-y-3">
            <div class="border-l-2 border-primary pl-4">
              <p class="font-mono text-sm font-semibold mb-1">handles</p>
              <p class="text-sm text-muted-foreground">
                <span class="font-mono text-xs">{"{ target: boolean; source: boolean; }"}</span> -
                Configuration for connection handles. Target renders on the left, source on the
                right.
              </p>
            </div>
            ...
            <div class="border-l-2 border-primary pl-4">
              ...
              <p class="text-sm text-muted-foreground">
                <span class="font-mono text-xs">string</span> - Additional CSS classes to apply to
                the node.
              </p>
            </div>
          </div>
        ...
        <div>
          <p class="font-semibold mb-3">&lt;NodeHeader /&gt;</p>
          <div class="border-l-2 border-primary pl-4">
            <p class="font-mono text-sm font-semibold mb-1">className?</p>
            <p class="text-sm text-muted-foreground">
              <span class="font-mono text-xs">string</span> - Additional CSS classes to apply to
        ...
        <div>
          <p class="font-semibold mb-3">&lt;NodeContent /&gt;</p>
          <div class="border-l-2 border-primary pl-4">
            <p class="font-mono text-sm font-semibold mb-1">className?</p>
            <p class="text-sm text-muted-foreground">
              <span class="font-mono text-xs">string</span> - Additional CSS classes to apply to
        ...
        <div>
          <p class="font-semibold mb-3">&lt;NodeFooter /&gt;</p>
          <div class="border-l-2 border-primary pl-4">
            <p class="font-mono text-sm font-semibold mb-1">className?</p>
            <p class="text-sm text-muted-foreground">
              <span class="font-mono text-xs">string</span> - Additional CSS classes to apply to
