...
<main class="min-w-0" bind:this={toc.ref}>
	...
	<p class="!text-muted-foreground my-2 text-lg">
		The <CodeSpan>Node</CodeSpan> component provides a composable, Card-based node for Svelte Flow
		canvases. It includes support for connection handles, structured layouts, and consistent styling
			...
			<div class="space-y-3">
				<div class="border-primary border-l-2 pl-4">
					...
					<p class="text-muted-foreground text-sm">
						...
						> - Configuration for connection handles. Target renders on the left, source on
						the right.
					</p>
				</div>
