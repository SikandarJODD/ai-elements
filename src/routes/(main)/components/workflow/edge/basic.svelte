<script lang="ts">
  ...
  let edges: EdgeType[] = $state([
    { id: 'e1-2', source: '1', target: '2', type: 'animated', label: 'Animated' },
    { id: 'e1-3', source: '1', target: '3', type: 'temporary', label: 'Temporary' },
    { id: 'e2-4', source: '2', target: '4', type: 'animated' },
    { id: 'e3-4', source: '3', target: '4', type: 'temporary' }
  ]);
</script>

<div class="h-[350px] w-full border rounded-lg overflow-hidden">
