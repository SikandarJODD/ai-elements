...
<main class="min-w-0" bind:this={toc.ref}>
	...
	<p class="!text-muted-foreground my-2 text-lg">
		The <CodeSpan>Edge</CodeSpan> component provides two pre-styled edge types for Svelte Flow canvases:
		<CodeSpan>Temporary</CodeSpan> for dashed temporary connections and
...
<Canvas bind:nodes bind:edges {edgeTypes} />`}
	...
	<div class="my-4 space-y-4">
		...
		<div class="border-primary border-l-2 pl-4">
			...
			<p class="text-muted-foreground text-sm">
				...
				repeats indefinitely with a 2-second duration, providing visual feedback for active
				connections.
			</p>
		</div>
	</div>
	...
	<AiElementsPrevNext currentSlug="edge" />
</main>
