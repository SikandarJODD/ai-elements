...
<main class="min-w-0" bind:this={toc.ref}>
	...
	<p class="!text-muted-foreground my-2 text-lg">
		The <CodeSpan>Controls</CodeSpan> component provides interactive zoom and fit view controls for
		Svelte Flow canvases. It includes a modern, themed design with backdrop blur and card styling.
	</p>
	...
	<div class="my-4 space-y-4">
		...
		<div class="border-primary border-l-2 pl-4">
			...
			<p class="text-muted-foreground text-sm">
				...
				- Any other props from @xyflow/svelte Controls component (showZoom, showFitView, showInteractive,
				position, etc.).
			</p>
		</div>
	</div>
