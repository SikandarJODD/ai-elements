...
```bash
npx shadcn-svelte@latest add https://sv-animations.vercel.app/r/context.json
```
...
Document the Context props here.

## Features

- Replace this placeholder bullet with a real Context feature.
