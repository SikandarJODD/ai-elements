  ...
  >
    ...
    <main class="min-w-0" bind:this={toc.ref}>
      ...
      <p class="my-2 !text-muted-foreground text-lg">
        The <CodeSpan>Context</CodeSpan> component provides a comprehensive view of AI model usage through a compound component system. It displays context window utilization, token consumption breakdown (input, output, reasoning, cache), and cost estimation in an interactive hover card interface.
      </p>
    ...
    ContextTrigger,
  } from "$lib/components/ai-elements/context/index";
\<\/script\>
