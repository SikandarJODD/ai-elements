...
const install_block: InstallComponentDocs = {
	packages: [],
	install_code: [
		{ name: "confirmation-accepted.svelte", code: ConfirmationAcceptedSvelteRaw, lang: "svelte", isExpand: true, },
		...
		{ name: "confirmation-context.svelte.ts", code: ConfirmationContextSvelteTsRaw, lang: "typescript", },
		{ name: "confirmation-rejected.svelte", code: ConfirmationRejectedSvelteRaw, lang: "svelte", },
