  ...
  >
    ...
    <main class="min-w-0" bind:this={toc.ref}>
      ...
      <p class="my-2 !text-muted-foreground text-lg">
        The <CodeSpan>Open In Chat</CodeSpan> component provides a dropdown menu
        that allows users to open queries in different AI chat platforms with a single
        click.
      </p>
      ...
      <Installation specifier={`${PUBLIC_WEBSITE_URL}/r/open-in-chat.json`} is_jsrepo={true} blockname="open-in-chat" />
