...
<main class="min-w-0" bind:this={toc.ref}>
	...
	<p class="text-muted-foreground my-4 text-base leading-relaxed sm:text-lg">
		UI blocks for AI applications, built with prompt-kit components. Copy and paste these blocks
		into your project to quickly build chat interfaces, conversations, and AI interactions.
	</p>
