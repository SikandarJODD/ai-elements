<script lang="ts">
  ...
  import { Subheading, AiInstallCommand, ComponentAPITable, H3 } from "$lib/components/docs";
  ...
  >
    ...
    <main class="min-w-0" bind:this={toc.ref}>
      ...
      <p class="mb-4 text-sm sm:text-base leading-relaxed text-muted-foreground">
        You can use <code
          class="bg-muted px-1.5 py-0.5 rounded text-sm">PromptInputActions</code
        > to add actions with tooltips to the <code
          class="bg-muted px-1.5 py-0.5 rounded text-sm">PromptInput</code
        >.
      </p>
      ...
      <div class="mb-6">
        <AiInstallCommand
          command="execute"
          args={["shadcn-svelte@latest", "add", "https://ai-elements.vercel.app/r/prompt-kit-prompt-input.json"]}
        />
      </div>
      ...
      <!-- PromptInput -->
      <ComponentAPITable componentName="PromptInput" props={promptInputProps} class="mt-6" id="promptinput" />

      <!-- PromptInputTextarea -->
      <ComponentAPITable componentName="PromptInputTextarea" props={promptInputTextareaProps} id="promptinputtextarea" />

      <!-- PromptInputActions -->
      <ComponentAPITable componentName="PromptInputActions" props={promptInputActionsProps} id="promptinputactions" />

      <!-- PromptInputAction -->
      <ComponentAPITable componentName="PromptInputAction" props={promptInputActionProps} id="promptinputaction" />
    </main>
    ...
    >
      <div>
        <H3 class="text-sm mb-4 mt-0">On this page</H3>
