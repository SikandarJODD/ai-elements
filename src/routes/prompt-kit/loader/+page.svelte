...
<Sidebar.Inset class="min-h-svh">
  ...
  >
    ...
    <main class="min-w-0" bind:this={toc.ref}>
      ...
      <h3 class="text-lg font-semibold mb-3 mt-6" id="basic-loader">Basic Loader</h3>
      ...
      <h3 class="text-lg font-semibold mb-3 mt-8" id="loader-sizes">Loader Sizes</h3>
      <p class="mb-4 text-sm sm:text-base leading-relaxed text-muted-foreground">
      ...
      <div class="mb-6">
        <AiInstallCommand
          command="execute"
          args={["shadcn-svelte@latest", "add", "https://ai-elements.vercel.app/r/prompt-kit-loader.json"]}
        />
      </div>

      <p class="mb-6 text-sm sm:text-base leading-relaxed text-muted-foreground">
        <strong>Note:</strong> If you are using Tailwind CSS v4, you may have to grab the keyframes and add them to your global.css file manually. Check manual installation for more details.
      </p>
      ...
      <!-- Loader -->
      <ComponentAPITable componentName="Loader" props={loaderProps} class="mt-6" id="loader-props" />
    </main>
