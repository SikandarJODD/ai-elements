...
<main class="min-w-0" bind:this={toc.ref}>
	...
	<p class="text-muted-foreground mb-6 text-base leading-relaxed sm:text-lg">
		A loading component with multiple variants to indicate processing states and provide visual
		feedback to users during wait times.
	</p>
	...
	<p class="text-muted-foreground mb-6 text-sm leading-relaxed sm:text-base">
		<strong>Note:</strong> If you are using Tailwind CSS v4, you may have to grab the keyframes and
		add them to your global.css file manually. Check manual installation for more details.
	</p>
	...
	<PromptKitPrevNext currentSlug="loader" />
</main>
