...
<main class="min-w-0" bind:this={toc.ref}>
	...
	<h3 class="mt-8 mb-3 scroll-m-20 text-lg font-semibold" id="tool-states">Tool States</h3>
	...
	<p class="text-muted-foreground mb-6 text-sm leading-relaxed sm:text-base">
		The Tool component is built using shadcn-svelte Collapsible primitives and provides both
		composed and composable patterns.
	</p>
	...
	<ComponentAPITable componentName="ToolComposed" props={toolComposedProps} class="mb-8" />
	...
	<p class="text-muted-foreground mb-3 text-sm">Collapsible content wrapper for tool details.</p>
	...
	<p class="text-muted-foreground mb-3 text-sm">TypeScript interface for tool invocation data.</p>
