...
<main class="min-w-0" bind:this={toc.ref}>
	...
	<p class="text-muted-foreground mb-6 text-base leading-relaxed sm:text-lg">
		A component for rendering Markdown content with support for GitHub Flavored Markdown (GFM)
		and custom component styling.
	</p>
	...
	<p class="text-muted-foreground mb-4 text-sm leading-relaxed sm:text-base">
		...
		>
		with <code class="bg-muted rounded px-1.5 py-0.5 text-sm">remark-gfm</code> to support GitHub
		Flavored Markdown, which includes:
	</p>
	...
	<p class="text-muted-foreground mb-4 text-sm leading-relaxed sm:text-base">
		...
		performance, especially in streaming AI response scenarios. This approach is crucial when
		rendering chat interfaces where new tokens are continuously streamed.
	</p>
	...
	<p class="text-muted-foreground mb-6 text-sm leading-relaxed sm:text-base">
		This pattern significantly improves performance in chat applications by preventing the
		entire message history from re-rendering with each new token, which becomes increasingly
	...
	<p class="text-muted-foreground mb-4 text-sm leading-relaxed sm:text-base">
		...
		<code class="bg-muted rounded px-1.5 py-0.5 text-sm">prose</code> classes that add beautiful typographic
