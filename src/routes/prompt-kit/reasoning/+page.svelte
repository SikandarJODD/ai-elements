...
<Sidebar.Inset class="min-h-svh">
  ...
  >
    ...
    <main class="min-w-0" bind:this={toc.ref}>
      ...
      <h3 class="text-lg font-semibold mb-3 mt-8" id="with-markdown">With Markdown</h3>
      <p class="mb-4 text-sm sm:text-base leading-relaxed text-muted-foreground">
      ...
      <div class="mb-6">
        <AiInstallCommand
          command="execute"
          args={["shadcn-svelte@latest", "add", "https://ai-elements.vercel.app/r/prompt-kit-reasoning.json"]}
        />
      </div>
      ...
      <!-- Reasoning -->
      <ComponentAPITable componentName="Reasoning" props={reasoningProps} class="mt-6" id="reasoning-props" />

      <!-- ReasoningTrigger -->
      <ComponentAPITable componentName="ReasoningTrigger" props={reasoningTriggerProps} id="reasoning-trigger-props" />

      <!-- ReasoningContent -->
      <ComponentAPITable componentName="ReasoningContent" props={reasoningContentProps} id="reasoning-content-props" />
    </main>
