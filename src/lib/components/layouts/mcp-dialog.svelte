...
<Dialog.Root>
	...
	<Dialog.Content class="sm:max-w-2xl ">
		...
		<Dialog.Description>Use the code below to setup MCP in your project.</Dialog.Description>
		<Tabs.Root value="cursor">
			...
			<Tabs.Content value="windsurf">
				Add the following code to your <CodeSpan>.codeium/windsurf/mcp_config.json</CodeSpan
				> file.
			</Tabs.Content>
		</Tabs.Root>
		<div>
