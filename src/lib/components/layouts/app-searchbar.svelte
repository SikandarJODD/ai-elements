<script lang="ts">
  ...
  import {
    searchNavigation,
    getNavigationGroups,
  } from "$lib/config/navigation-data";
...
>
  ...
  <div class="flex items-center gap-1">
    <kbd
      class="bg-background text-muted-foreground pointer-events-none hidden h-5 select-none items-center gap-1 rounded border px-1.5 font-mono text-[10px] font-medium opacity-100 sm:inline-flex"
    >
      Ctrl
    </kbd>
    <kbd
