<script lang="ts">
	...
	import * as Icons from "$lib/components/icons/index.js";
</script>
			...
			<div class="mx-auto max-w-5xl px-6 md:px-6">
				<div class="sm:mx-auto lg:mt-0 lg:mr-auto">
					...
					<div class="mt-12 flex items-center gap-1 md:gap-3">
						<Button
							size="lg"
							class="h-10.5 rounded-full font-normal md:text-base"
						...
						<Button
							...
							target="_blank"
							rel="noreferrer"
							class="border-secondary h-10.5 rounded-full border font-normal md:text-base"
						>
